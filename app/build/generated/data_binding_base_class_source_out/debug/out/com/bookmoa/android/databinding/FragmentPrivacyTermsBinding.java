...
public final class FragmentPrivacyTermsBinding implements ViewBinding {
  ...
  private FragmentPrivacyTermsBinding(@NonNull ScrollView rootView, @NonNull TextView FAQTv,
  ...
  @NonNull
  public static FragmentPrivacyTermsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPrivacyTermsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_privacy_terms, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPrivacyTermsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPrivacyTermsBinding((ScrollView) rootView, FAQTv, backIc, topbarGuideline);
    }
